...
export const searchLatestResults = async ({ query }) => {
  ...
  /**
   * If there are only a few results, Kleinanzeigen likes to show ads from other
   * locations. It puts these in `#srchrslt-adtable-altads`, so we should
   * deliberately only show ads from within `#srchrslt-adtable`.
   */
